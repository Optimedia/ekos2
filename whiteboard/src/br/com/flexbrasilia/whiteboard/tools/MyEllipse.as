package br.com.flexbrasilia.whiteboard.tools
{
	...
	public class MyEllipse extends DrawingTool
	{
		...
		override public function moveDrawing(event:MouseEvent):void
		{
			...
			//se estiver segurando Shift, faz uma circunferência perfeita
			if( event.shiftKey ) {
				var dif:Number;
				...
				if( xDif >= 0 && yDif >= 0 ) {
					...
					shape.graphics.drawEllipse(startX, startY, dif, dif);
				}
			...
			//se nao estiver segurando o Shift
				...
				shape.graphics.drawEllipse(startX, startY, endX-startX, endY-startY);
			}
		}
