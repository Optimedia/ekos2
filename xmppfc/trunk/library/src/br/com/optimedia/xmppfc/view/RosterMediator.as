...
package br.com.optimedia.xmppfc.view {
	...
	public class RosterMediator extends Mediator implements IMediator {
		...
		override public function handleNotification(note:INotification):void {
			...
			switch (note.getName()) {
				case ApplicationFacade.VALID_LOGIN:
					...
					viewComponent.rosterList.dataProvider = xmppProxy.getRosterDataProvider();
					break;
				case ApplicationFacade.DISCONNECT:
					rosterView.titleWindow.enabled = false;
					viewComponent.rosterList.dataProvider = null;
					break;
				default:
					break;		
			}
		 ...
		 */
		protected function get rosterView():* {
		 ...
		 * @param	chatEvent
		 */
		protected function onStartChat(chatEvent:ChatEvent):void {
