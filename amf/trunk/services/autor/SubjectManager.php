<?php
	...
	class SubjectManager extends SqlManager {
		...
		public function savePresentation(PresentationVO $presentation) {
			...
			if($presentation -> title != "" && $presentation -> description != "") {
				if($presentation -> presentation_id == 0) {
					...
					// Verificar se a presentation estÃ¡ liberada, se sim, atualizar os dados, se nÃ£o retornar false;
					...
					// Verificando se a presentation estÃ¡ liberada.
		...
		public function deleteSubject($subject_id) {
			...
			// Verificar se hÃ¡ presentations ligadas a esse subject
