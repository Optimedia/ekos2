<?php
	...
	class FriendManager extends SqlManager {
		...
		public function getAllFriends() {
			$sql = "SELECT a.account_id ,u.first_name, u.last_name, p.small_avatar, p.nickname FROM eko_friend f, eko_ignore i, eko_account a, eko_user u, eko_profile p ".
				   "WHERE profile_id_i=".$_SESSION['account_id']." AND account_id=f.profile_id_you AND u.user_id=f.profile_id_you AND p.profile_id=f.profile_id_you ". 
				   "AND (i.profile_id_i=".$_SESSION['account_id']." AND i.profile_id_you=f.profile_id_you)";
